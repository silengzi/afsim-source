...
This demo directory demonstrates the use of WSF_NOISE_CLOUD.  It defines
a noise cloud layer and uses it to affect detections of an air target from
a radar.  This demo uses sensor_plot.
