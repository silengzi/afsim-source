...
This scenario contains a single platform that orbits the moon using the
WSF_INTEGRATING_SPACE_MOVER. This outputs a single replay file that can
be used to examine the results of the orbit. The scenario also includes
a mechanism to easily modify the initial conditions.
